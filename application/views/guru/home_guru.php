...
<!-- Top Bar -->
        ...
        <div class="col-xl-12 col-lg-7">
            ...
            <div class="card-body"><center>
                <h4 class="m-0 font-weight-bold text-primary">Selamat Datang '<?= $nama ?>'</h4><br>
                <img style=" width: 80%; height: auto;" src="<?=base_url();?>static/dashboardTemplates/img/think.svg" ></center>
            </div>
            </div>
        </div>
        </div>
