      ...
      <div class="container">
        <div class="row align-items-center py-5">
          <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
            <div class="pr-lg-5"><img src="<?=base_url();?>static/loginTemplates/images/logo_login.png" alt="" class="img-fluid"></div>
          </div>
            ...
            $.ajax({
              ...
              success:function(response){
                ...
                if (response == "success_siswa") {
                  ...
                  .then (function() {
                    window.location.href = "<?php echo base_url() ?>core/siswa";
                  });

                } else if (response == "success_guru") {
                  ...
                  .then (function() {
                    window.location.href = "<?php echo base_url() ?>core/guru";
                  });
