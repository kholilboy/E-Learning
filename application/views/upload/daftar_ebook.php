  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="display: inline-flex;"><button title="Edit" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_edit<?php echo $u->id;?>"><i class="fa fa-edit" style="color: white"></i></button>&nbsp;
        ...
        <form action="<?php echo base_url('operasi/delete_ebook') ?>" method="post">
    ...
    ?>
      <tr>
        <td colspan="6">Belum Ada Ebook</td>
      </tr>
    <?php  
    }
    ?>
         ...
         ?>
          ...
          <!-- Modal -->
            <div class="modal fade" id="modal_edit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url().'operasi/edit_ebook'?>">
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Upload Ebook</label>
                            <div class="col-xs-8">
                                <input name="upload_ebook" value="<?php echo $upload_ebook ?>" class="form-control" type="text" placeholder="" required>
                            </div>
                        </div>
